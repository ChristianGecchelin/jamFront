...
const NewPlace = () => {
    ...
    console.log(user)
    const handleNamePlace = (e) => setNamePlace(e.target.value);

    const handleNamePlace = (e) => setNamePlace(e.target.value); const handleNamePlace = (e) => setNamePlace(e.target.value);
